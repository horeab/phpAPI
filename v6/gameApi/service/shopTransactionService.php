...
class ShopTransactionService extends AbstractService
{
    ...
    function createShopTransaction($userId, $entityCreationDate, $experienceGain, $coinsAmount, $transactionType)
    {
        $query = "INSERT INTO " . $this->getTableName() . " (userId, entityCreationDate, coinsAmount, experienceGain, transactionType)
                  VALUES (:userId, :entityCreationDate, :coinsAmount, :experienceGain, :transactionType)";
