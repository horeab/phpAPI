...
require_once $_SERVER['DOCUMENT_ROOT'] . Constants::$GAMEAPIVERSION . '/gameApi/model/user.php';
...
class UserService extends AbstractService
{
    ...
    {
        $query = "SELECT * FROM " . $this->getTableName() . " WHERE gameId = :gameId ORDER BY RAND() LIMIT 8";
