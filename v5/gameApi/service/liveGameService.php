...
class LiveGameService extends AbstractService
{
    ...
    function createLiveGame($user1Id, $user2Id, $question, $gameConfig, $initialUserStatus)
    {
        $query = "INSERT INTO " . $this->getTableName() . " (user1Id, user2Id, user1Status, user2Status, question, gameConfig)
                  VALUES (:user1Id, :user2Id, :user1Status, :user2Status, :question, :gameConfig)";
    ...
    function getLiveGame($user1Id, $user2Id)
    {
        ...
        $liveGame->question = $row['question'];
