...
class UserService extends AbstractService
{
    ...
    function getUserForId($userId)
    {
        ...
        $user = new User();
        $user->id = $row['id'];
        $user->entityCreationDate = $row['creationDate'];
    ...
    {
        $query = "INSERT INTO " . $this->getTableName() . " (externalId, fullName, accountCreationSource, lastTimeActiveDate, creationDate, gameId) 
